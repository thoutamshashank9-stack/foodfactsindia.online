...
export function generateSvgFallback(barcode) {
...
export async function fetchUpstreamOffImage(barcode) {
...
export async function handleImageProxyRequest(req, res, barcode) {
