...
BATCH44_DATA = """barcode,product_name,brands,ingredients_text,additive_flags,confidence
...
8901725000370,Sunfeast Marie Light Active,Sunfeast,"Refined wheat flour, sugar, refined palm oil, invert sugar syrup, milk solids, raising agents, salt, emulsifiers",Clean,KB_HIGH
...
8901719130724,Parle 20-20 Gold,Parle,"Refined wheat flour, sugar, edible vegetable oil, cashew nuts, invert syrup, milk solids, raising agents (INS 503(ii), INS 500(ii)), emulsifier (INS 322)",Clean,KB_HIGH
...
8901725004576,Bingo Hashtags,Bingo,"Corn grits, edible vegetable oil, rice grits, gram flour, spices, salt, sugar, flavour enhancers (INS 621, INS 627, INS 631), colours (INS 160c)",INS 621 MSG + INS 160c,KB_HIGH
...
8901512557308,Act Nachoz Cheese,Act II,"Corn flour, edible vegetable oil, cheese powder, salt, spices, flavour enhancers",Clean,KB_HIGH
...
8906010504021,Balaji Wafers,Balaji,"Potato, edible vegetable oil, salt, spices",Clean,KB_HIGH
8906010504007,Balaji Wafers,Balaji,"Potato, edible vegetable oil, salt, spices",Clean,KB_HIGH
...
8906081381361,Chekodilu,Telugu Foods,"Rice flour, coconut, jaggery, edible vegetable oil, cardamom",Clean,KB_HIGH
...
8901928350951,Googly,Bisk Farm,"Verify specific product",Verify,KB_MEDIUM
...
89040370016,India Salaam Basmati Rice Classic,Various,"Basmati rice (100%)",Clean single-ingredient,KB_HIGH
...
8906040375226,Salaam Bashmati Rice,Various,"Basmati rice (100%)",Clean single-ingredient,KB_HIGH
...
def run():
    print("=== EXECUTING BATCH 44 INGREDIENTS INTEGRATION & PURGE ===")
    global df_all, df_confirmed, df_needs_ver
    
    batch_reader = csv.DictReader(io.StringIO(BATCH44_DATA.strip()))
    batch_44_rows = list(batch_reader)

    elevated_count = 0
    added_count = 0
    purged_count = 0

    for item in batch_44_rows:
    ...
    print(f"Batch 44 Processing Summary:")
