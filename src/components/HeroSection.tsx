              ...
              {isSearching && searchResults.length === 0 ? (
                ...
                <div className="p-4 text-center text-xs text-slate-500 dark:text-slate-400 flex flex-col items-center gap-2">
                  ...
                  {/^[0-9]{8,14}$/.test(searchQuery.trim()) ? (
                    <span>Scanned product details is not available currently. We currently only maintain data for verified food products we have collected. Beauty, cosmetics, and non-food items are not in our database.</span>
                  ) : (
