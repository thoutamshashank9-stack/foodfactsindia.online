    ...
    <footer className="mt-16 border-t border-stone-200 dark:border-stone-800 bg-[#fcfbf9] dark:bg-[#0e1117] text-stone-600 dark:text-stone-400 py-10 transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="pt-6 border-t border-stone-200 dark:border-stone-800 text-[10px] text-stone-400 dark:text-stone-500 leading-relaxed space-y-2">
          ...
          <p>
            <strong className="text-stone-500 dark:text-stone-400">Data Sources & Provenance:</strong> Product records on FoodFactsIndia.online are aggregated from: (1) the <a href="https://openfoodfacts.org" target="_blank" rel="noopener noreferrer" className="underline hover:text-stone-600 dark:hover:text-stone-300">Open Food Facts</a> open database (ODbL license) — identifiable by community-contributed barcode scans; (2) user-submitted label photographs processed via OCR; and (3) official brand publications where available. Every record carries a source tag. Records lacking verified ingredient text are displayed as &quot;Pending Verification&quot; and are never flagged for regulatory divergence.
          </p>
          <p>
