        ...
        {selectedProduct ? (
          <div className="space-y-6">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm"
            >
              <ArrowLeft className="w-4 h-4" />
              <span>Back to Product Search</span>
            </button>

            <TransparencyReportView report={selectedProduct} />
          </div>
        ) : (
          <>
            {/* TAB 1: HOME & EXPLORE */}
